    ...
    <style>
        * {
        ...
        .description p {
            ...
            font-style: italic;
            font-weight: bold; /* Puedes agregar negrita para más presencia */
            line-height: 1.5; /* Ajusta la altura de línea según tus preferencias */
            margin-bottom: 10px; /* Puedes ajustar el margen inferior según tus preferencias */
            background-color: rgba(255, 255, 255, 0.8);
            padding: 10px; /* Agrega relleno para separar el texto del fondo */
        ...
        @media (max-width: 767px) {
            ...
            .description p {
                ...
                border-radius: 2rem; /* Opcional: Agrega bordes redondeados */
            }
        ...
        <div class="container  h-100">
            <div class="row gx-lg-5  align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 ">
                    ...
                    <p class="text-white align-items-center p-0">ÚLTIMOS JUEGOS AGREGADOS</p>
        ...
        <div class="  ">
            <div class="row  justify-content-center">
                <div class="text-center">
                    <p class="text-white" id="acerca">Reseña Y Puntúa Tus Juegos Favoritos</p>
                    <hr class="divider divider-light"/>

                    <img src="{{asset('images/soinc.gif')}}" class="w-25" alt="">
                    <img src="{{asset('images/mario-super-unscreen.gif')}}" style="width:  18%;" alt="">

                    <p class="text-white mb-4 mx-5  mx-mobile-0">Gamesnotes es una página enfocada en los videojuegos y
                        en las reseñas
