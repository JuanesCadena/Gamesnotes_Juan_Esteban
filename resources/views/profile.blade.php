...
@section('content')
    ...
    <div class="container mov" style="margin-top: 4rem">
        <h1 class="text-white text-center ">{{ strtoupper($user->name) }}</h1>
        <hr class="text-white"> <!-- Barra horizontal -->

    </div>
    <h2 class="text-white text-center">Juegos favoritos</h2>

    @if($favorites->isEmpty())
        <p class="text-white text-center mt-5 mb-5">No hay juegos favoritos agregados </p>
    @else
                ...
                <div class="game-item">
                    ...
                    <div class="fw-semibold">
                        <a class="text-decoration-none" href="{{ route('video_games.show', $favorite->game_id) }}">
                            <h3 class="text-white text-center mt-4">{{ $favorite->game_name }}</h3>
                        </a>
                    </div>
                </div>
            @endforeach
    ...
    <h2 class="text-white text-center" style="margin-bottom: -1rem">Comentarios</h2>
                ...
                @foreach($comments as $comment)
                    <div class="col-md-6">
                        <a class="text-decoration-none" href="{{ route('video_games.show', $comment->video_game_id) }}">
                            <h3 class="text-white text-center mt-4">{{ $comment->videoGame->name }}</h3>
                        </a>
